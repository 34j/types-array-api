...
class Array[TDtype, TDevice](Protocol):
    ...
    def __getitem__(self, key: int | slice | ellipsis | tuple[int | slice | ellipsis | Self | None, ...] | Self | None, /) -> Self:
        """
        Returns ``self[key]``.
...
class meshgrid[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(self, /, *arrays: TArray, indexing: Literal["xy", "ij"] = "xy") -> tuple[TArray, ...]: ...
...
@runtime_checkable
class eig[TArray: Array](Protocol):
    """
...
@runtime_checkable
class eigvals[TArray: Array](Protocol):
    """
...
class searchsorted[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(self, x1: TArray, x2: TArray | int | float, /, *, side: Literal["left", "right"] = "left", sorter: TArray | None = None) -> TArray: ...
...
class broadcast_arrays[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(self, /, *arrays: TArray) -> tuple[TArray, ...]: ...


@runtime_checkable
class broadcast_shapes(Protocol):
    """
    ...
    @abstractmethod
    def __call__(self, /, *shapes: tuple[int | None, ...]) -> tuple[int | None, ...]: ...
...
@runtime_checkable
class isin[TArray: Array](Protocol):
    """
    ...
    @abstractmethod
    def __call__(self, x1: TArray | int, x2: TArray | int, /, *, invert: bool = False) -> TArray: ...
