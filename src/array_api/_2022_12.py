...
@runtime_checkable
class from_dlpack[TArray: Array](Protocol):
    """
...
@runtime_checkable
class ArrayNamespace[TArray: Array, TDevice, TDtype](Protocol):
...
@runtime_checkable
class ArrayNamespaceFull[TArray: Array, TDevice, TDtype](ArrayNamespace[TArray, TDevice, TDtype], Protocol):
