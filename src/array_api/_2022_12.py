...
@runtime_checkable
class astype[TArray: _array, TDtype](Protocol):
...
.. versionchanged:: 2022.12
   Added complex data type support."""
    ...
    @abstractmethod
    def __call__(self, x: TArray, dtype: TDtype, /, *, copy: bool=True) -> TArray:
        ...
...
@runtime_checkable
class from_dlpack[TArray: _array](Protocol):
...
out: array
    ...
    @abstractmethod
    def __call__(self, x: object, /) -> TArray:
        ...
...
class ArrayNamespace[TSupportsbufferprotocol, TArray: _array, TDevice, TDtype](Protocol):
    ...
    from_dlpack: from_dlpack[TArray,]
